...
export default function SuggestWordModal({
  ...
  const isFormValid = () => {
    ...
    if (isRiddle) {
      return form.answer.trim().length > 0 && turnstileToken !== null;
    }
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-emerald-600/70 text-[10px] font-medium uppercase tracking-[0.2em] mt-2 flex items-center gap-1">
                  ...
                  Build the Nandi Dictionary
                </p>
                <VisuallyHidden.Root>
                  <DialogDescription>Contribute to Kutiit</DialogDescription>
                </VisuallyHidden.Root>
              </div>
            </div>
            <Button
        ...
        <div className="flex-1 overflow-y-auto p-8 bg-white relative z-20">
          {submitted ? (
            <div className="py-24 text-center animate-in zoom-in-95 duration-500">
              ...
              <p className="text-slate-500 mt-3 text-lg font-medium italic px-10">
                Your contribution helps keep the Nandi language alive.
              </p>
            </div>
          ) : (
            <div className="space-y-8 pb-12">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-3">
                      <Input
                        ...
                        placeholder="Indefinite: e.g. tany"
                        value={form.singular_indefinite}
                        onChange={handleInputChange}
                        className="h-14 bg-white border-slate-200 rounded-xl text-base font-normal text-slate-700 placeholder:text-slate-400 focus-visible:ring-emerald-500"
                      />
                      <Input
                        name="singular_definite"
                        placeholder="Definite: e.g. teta"
                        value={form.singular_definite}
                        onChange={handleInputChange}
                        className="h-14 bg-white border-emerald-200 rounded-xl text-base font-normal text-slate-700 placeholder:text-slate-400 focus-visible:ring-emerald-500"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-3">
                      <Input
                        ...
                        placeholder="Indefinite: e.g. tich"
                        value={form.plural_indefinite}
                        onChange={handleInputChange}
                        className="h-14 bg-white border-slate-200 rounded-xl text-base font-normal text-slate-700 placeholder:text-slate-400 focus-visible:ring-emerald-500"
                      />
                      <Input
                        name="plural_definite"
                        placeholder="Definite: e.g. tuga"
                        value={form.plural_definite}
                        onChange={handleInputChange}
                        className="h-14 bg-white border-emerald-200 rounded-xl text-base font-normal text-slate-700 placeholder:text-slate-400 focus-visible:ring-emerald-500"
                      />
                    </div>
              ...
              {isVerb && (
                <div className="bg-amber-50/20 p-6 rounded-3xl border border-amber-200/50 space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    className="h-14 bg-white border-amber-200 rounded-2xl text-base font-normal text-slate-700 placeholder:text-slate-400 focus-visible:ring-amber-500"
                  />
                </div>
              )}
              ...
              {!isProverbOrSaying && !isRiddle && (
                <div className="space-y-2">
                  ...
                  <Textarea
                    name="examples"
                    placeholder="Provide both Nandi and English, separated by a dash e.g. Chamgei - Hello"
                    value={form.examples}
                    onChange={handleInputChange}
